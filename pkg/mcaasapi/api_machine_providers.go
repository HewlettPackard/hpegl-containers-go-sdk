...
/*
MachineProvidersApiService Gets all Machine Providers
...
func (a *MachineProvidersApiService) V1AppliancesIdMachineprovidersGet(ctx context.Context, id string) (MachineProviders, *http.Response, error) {
	var (
		...
		localVarReturnValue MachineProviders
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/appliances/{id}/machineproviders"
